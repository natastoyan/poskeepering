...
{
    public partial class Equitingdeals
    {
        ...
        public bool? Bisbrokbook { get; set; }

        public virtual Eqbooks CbookcodeNavigation { get; set; }
        public virtual Eqdealers CdealercodeNavigation { get; set; }
        public virtual Currency CsalescreditcurrNavigation { get; set; }
        public virtual Currency CsettlcurrcodeNavigation { get; set; }
        public virtual Currency CtradecurrcodeNavigation { get; set; }
