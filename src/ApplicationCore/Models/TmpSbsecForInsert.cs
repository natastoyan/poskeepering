...
{
    public partial class TmpSbsecForInsert
    {
        public decimal? Nsbseckey { get; set; }
        public decimal? Bautoprint { get; set; }
        ...
        public decimal? Nfullamount { get; set; }
        ...
        public decimal? Bnosummit { get; set; }
        ...
        public decimal? Nsettlementkey { get; set; }
        public decimal? Nsettplacekey { get; set; }
        public decimal? Ntradeplacekey { get; set; }
        public string Csettlementkey { get; set; }
        public string Csettplacekey { get; set; }
        public string Ctradeplacekey { get; set; }
        public string Csec { get; set; }
        public string Ctranshkey1 { get; set; }
        public string Ccrsstatus { get; set; }
        public string Cisb { get; set; }
