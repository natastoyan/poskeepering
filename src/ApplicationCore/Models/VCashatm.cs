...
{
    public partial class VCashatm
    {
        public DateTime? Dcontrdate { get; set; }
        public decimal? Nsumusdb { get; set; }
        public decimal? Nsumusds { get; set; }
        public decimal? Nsumrurb { get; set; }
        public decimal? Nsumrurs { get; set; }
